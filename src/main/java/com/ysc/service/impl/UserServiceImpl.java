...
//        userMapper.insertUser(account,password,name,creatTime,telephone);
        userMapper.insertUser(account,password,name,creatTime);
    }
    ...
    public User getUserID(String account) {
        return userMapper.selectUserByAccountAndPassword(account);
    }

    @Override
    public void addLoginStatus(String id, Integer userId) {
        userMapper.insertLoginStatus(id,userId);
    }

    @Override
    public LoginStatus searchLoginStatus(String id) {
        return userMapper.selectLoginStatus(id);
    }
